...
public class MyConstant {
    ...
    // Swagger Info
    public static final String SWAGGER_INFO_TITLE = "GiftCraft";
    public static final String SWAGGER_INFO_DESCRIPTION = "  ";
    public static final String SWAGGER_INFO_VERSION = "1.0.0";
    public static final String SWAGGER_INFO_CONTACT_NAME = "Sam";
    public static final String SWAGGER_INFO_CONTACT_EMAIL = "sam@example.com";
